...
* 9/24/2017*/
public class PageHourlyForecastFragment extends Fragment implements IForecastRecyclerViewAdapterListener {
    ...
    public void onNavigateToDetails(WeatherBean bean) {
        mActivityListener.onNavigateToDetailsForecast(bean);
    ...
    public static PageHourlyForecastFragment newInstance(List<WeatherBean> list) {
        PageHourlyForecastFragment fragment = new PageHourlyForecastFragment();
        fragment.list = list;
        return fragment;
    }
}
